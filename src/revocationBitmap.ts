import {Account, RevocationBitmap, ExplorerUrl} from "@iota/identity-wasm/node"
...
async function addRevocationBitmap(name: string, password: string, fragment: string){
