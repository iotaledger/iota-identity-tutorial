import {Subject, SubjectHolderRelationship, PresentationValidationOptions, Resolver, FailFast, VerifierOptions, ProofOptions, Account, Credential, RevocationBitmap, Presentation} from "@iota/identity-wasm/node"
